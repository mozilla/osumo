        ...
        $timeout(function() {
          ...
          DataService.hasImage(originalSrc).then(
            ...
            function() {
              ...
              // We also observe that sometimes the element itself can be surrounded
              // by something like a span.for or others but still by itself. Those
              // will be detected as false positives.
