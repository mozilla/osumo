...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description=("Generate the final locale "
                                                  "file that would be used by "
                                                  "the app."))
    parser.add_argument("directories", nargs="+", help=("The directories that "
                                                        "the po files are "
                                                        "from."))
    ...
    parser.add_argument("-t",
                        "--type",
                        help=("Type of the output. Could either be just a "
                              "json or a valid js file (attaching to "
